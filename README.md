...
`https://antonypamo-apisavant2.hf.space`, imprime un aviso en los logs de CI y
los umbrales de performance no bloquean el build (solo registran los resultados
en los artefactos).
